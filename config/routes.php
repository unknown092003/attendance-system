...
return [
    ...
    '/admin/users/update-status' => ['controller' => 'AdminController', 'action' => 'updateUserStatus', 'admin' => true],
    ...
    '/admin/change-password' => ['controller' => 'AdminController', 'action' => 'changePassword', 'admin' => true],
