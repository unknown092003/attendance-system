...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (endDayBtn) {
        endDayBtn.addEventListener('click', () => {
            ...
            const hasJournal = hasJournalElement && hasJournalElement.value === 'true';

            if (hasJournal) {
                if (confirm('You already have a journal entry for today. Do you want to end your day and reset the timer?')) {
